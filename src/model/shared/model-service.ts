...
export function resolveModelGetter(options: any): any {
  const maybeModelGetter = (value: any) => typeof value === 'function' && value.length === 0;
  const isModel = (value: { prototype: any; }) => value && value.prototype && value.prototype instanceof Model;
  const isOptionObjectOrArray = (value: any) => value && typeof value === 'object';
